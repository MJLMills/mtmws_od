...
\newthought{The Lorenz system\sidenote{Lorenz, E.N. (1963) \textit{Deterministic Nonperiodic Flow}. Journal of Atmospheric Sciences, 20, 130-141} is a set of} three coupled, first-order ordinary differential equations.
