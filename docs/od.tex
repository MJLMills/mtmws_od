...
\newthought{The Lorenz system\sidenote{Deterministic Nonperiodic Flow, Edward N. Lorenz} is a set of} three coupled, first-order ordinary differential equations.
